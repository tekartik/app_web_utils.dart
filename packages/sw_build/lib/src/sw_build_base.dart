...
/// Generate a web app service worker for a give folder
Future<void> generateWebAppServiceWorker(String dir) async {
  var entities = Directory(dir).listSync(recursive: true);
